...
use ckb_vm::{
    ...
    instructions::{Rtype, Stype},
    machine::VERSION1,
    ISA_IMC,
};
use ckb_vm_contrib::assembler::assemble;
use proptest::prelude::*;
use utils::{assert_same_inst, rtype_op, stype_branch_op, stype_store_op, VecMemory};
...
proptest! {
    ...
    #[test]
    fn assemble_stype_branch_instruction(op in stype_branch_op(), rs1 in 0usize..32usize, rs2 in 0usize..32usize, imm in -2048i32..2048i32) {
    ...
    #[test]
    fn assemble_stype_store_instruction(op in stype_store_op(), rs1 in 0usize..32usize, rs2 in 0usize..32usize, imm in -2048i32..2048i32) {
